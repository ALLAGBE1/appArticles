...
class MyClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.lineTo(size.width, size.height - 100); // Coin inférieur droit de la fente
    path.lineTo(size.width - 100, size.height); // Coin inférieur droit de la fente
    path.lineTo(0, size.height); // Coin inférieur gauche

    // Ajout de la ligne horizontale après la fente du bas
    double bottomLineY = size.height - 50; // Position de la ligne horizontale après la fente du bas
