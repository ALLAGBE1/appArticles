...
import 'package:tosho/page1.dart';
import 'package:tosho/tosho_colors.dart';

void main() {
  runApp(const MyApp(colors: lightToshoColors,));
}
...
class MyApp extends StatelessWidget {
  ...
  const MyApp({Key? key, required this.colors}) : super(key: key);
